...
class EditMedRecord(forms.ModelForm):
    ...
    bloodpressure = forms.CharField(label='Tekanan Darah:', widget=forms.TextInput(attrs={'class': 'form-control', 'placeholder': 'Tekanan Darah (mmHg)', 'name': 'bloodpressure'}))
    illnesses = forms.CharField(label='Riwayat Penyakit:', widget=forms.TextInput(attrs={'class': 'form-control', 'placeholder': 'Riwayat Alergi', 'name': 'illnesses'}))
    allergies = forms.CharField(label='Riwayat Alergi:', widget=forms.TextInput(attrs={'class': 'form-control', 'placeholder': 'Riwayat Alergi', 'name': 'allergies'}))
